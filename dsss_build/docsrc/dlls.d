...
$(SECTION
$(SHORT_TITLE How to create a DLL library using $(I Bud).)
$(BR)
When $(I Bud) finds a $(B DllMain()) function, or the $(B -dll) switch is used, it
...
library to interface with the DLL. $(I Bud) currently supports both the
